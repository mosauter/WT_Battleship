...
/**
 * GameInstance is a wrapper for a single instance of a
 * {@link de.htwg.battleship.Battleship} game.
 * So for that it contains both sockets to communicate
 * with the players.
 *
 * To initialize an instance you need the first socket for this player.
 * Via a setter you can later add a second socket.
 *
 * @author ms
 * @since 2015-12-05
 */
public class GameInstance {
    ...
    public GameInstance(final Battleship instance,
                        final Out socketOne,
